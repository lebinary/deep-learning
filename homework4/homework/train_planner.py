...
def train(
    ...
    **kwargs,
    ...
    # Load full datasets
    full_train_data = load_data("drive_data/train", shuffle=True, transform_pipeline=transform_pipeline, batch_size=batch_size, num_workers=num_workers)
    full_val_data = load_data("drive_data/val", shuffle=False, transform_pipeline=transform_pipeline)
